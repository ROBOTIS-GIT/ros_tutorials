...
protected:
  ...
  ros::NodeHandle nh_;
  actionlib::SimpleActionServer<ros_tutorials_action::FibonacciAction> as_; // NodeHandle instance must be created before this line. Otherwise strange error occurs.
